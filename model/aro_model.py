...
class gasa_classifier(torch.nn.Module):
    ...
    def __init__(self, dropout, num_heads, hidden_dim1, hidden_dim3, hidden_dim2, n_tasks=11, in_dim=39):
        super(gasa_classifier, self).__init__()
        self.motif_trans = Motif_trans()
        self.gnn = global_attention(in_dim, hidden_dim3 * num_heads, num_heads, edge_feat_size=5, dim=hidden_dim1)
