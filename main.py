...
def random_data_get():
    with open(r'/data2/jghu/meta_pathway/GASA_heter_vir/train_smi.txt') as f:
        data_left = [line.strip().split('\t') for line in f]
    with open(r'/data2/jghu/meta_pathway/GASA_heter_vir/test_smi.txt') as f:
...
def new_smi_prop(smi):
    with open(r'/data2/jghu/meta_pathway/GASA_heter_vir/cpd_class_end.txt') as f:
